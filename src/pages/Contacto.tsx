...
const CONTACT_ITEMS: ContactItem[] = [
  ...
  { icon: Instagram, color: '#E8525A', label: 'Instagram', value: '@nexosespacioterapeutico' },
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            {CONTACT_ITEMS.map(({ icon: Icon, color, label, value }) => (
            ...
            <a
              ...
              className="inline-flex items-center gap-3 text-white font-semibold px-6 py-3.5 rounded-full hover:opacity-90 transition-opacity shadow-md mt-4 w-full justify-center"
            >
