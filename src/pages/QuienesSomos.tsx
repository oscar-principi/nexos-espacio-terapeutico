      ...
      >
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <h1 style={{ color: '#5A6B7B' }} className="text-5xl font-light mt-3 mb-5">
            Un equipo unido por
            <br />
            <span style={{ color: 'var(--color-primary)', fontWeight: 600 }}>el cuidado del otro</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-14 items-center">
          <Reveal className="relative flex justify-center">
            ...
            >
              ...
              >
                <span style={{ color: 'var(--color-primary)', fontWeight: 700, fontSize: 22 }}>+7</span>
          ...
          <Reveal delay={150}>
            ...
            <div className="flex gap-8">
              {STATS.map(({ n, label }) => (
                <div key={label}>
                  <p style={{ color: 'var(--color-primary)', fontWeight: 700 }} className="text-2xl">
                    <CountUp value={n} />
                  </p>
